...
ggsave("images/repositioned_map.png", p, width = 10, height = 6, dpi = 300)
```

![Repositioned US Map](images/repositioned_map.png)
...
ggsave("images/vote_shift_map.png", map, width = 10, height = 6, dpi = 300)
```

![Vote Shift Arrows](images/vote_shift_map.png)
