...
<div style="display: flex; flex-wrap: wrap; gap: 30px; margin-top: 30px; justify-content: flex-start;">
  ...
  <div style="flex: 1 1 250px; background-color: #121212; padding: 20px; border-radius: 20px; box-shadow: 0 0 10px #00FF00;">
    ...
    <p style="color: #d0e6ff;">Student Performance: Academic predictors and trends.</p>
  </div>

  <div style="flex: 1 1 250px; background-color: #121212; padding: 20px; border-radius: 20px; box-shadow: 0 0 10px #00FF00;">
    <h3><a href="mp02.html" style="color: #00FF00; text-decoration: none;">🏙️ Mini Project 02</a></h3>
    <p style="color: #d0e6ff;">NYC Real Estate: Pricing, location insights, and remote work.</p>
  </div>

  <div style="flex: 1 1 250px; background-color: #121212; padding: 20px; border-radius: 20px; box-shadow: 0 0 10px #00FF00;">
    <h3><a href="mp03.html" style="color: #00FF00; text-decoration: none;">🎶 Mini Project 03</a></h3>
    <p style="color: #d0e6ff;">Spotify Data: Curating the Echoes of Euphoria playlist.</p>
  </div>

  <div style="flex: 1 1 250px; background-color: #121212; padding: 20px; border-radius: 20px; box-shadow: 0 0 10px #00FF00;">
    <h3><a href="mp04.html" style="color: #00FF00; text-decoration: none;">🗳️ Mini Project 04</a></h3>
    <p style="color: #d0e6ff;">Mapping Vote Shifts from 2020 to 2024 Across U.S. Counties.</p>
  </div>

  <div style="flex: 1 1 250px; background-color: #121212; padding: 20px; border-radius: 20px; box-shadow: 0 0 10px #00FF00;">
    <h3><a href="final-project.html" style="color: #00FF00; text-decoration: none;">🚉 Final Project</a></h3>
    <p style="color: #d0e6ff;">The New Normal Commute: Remote Work Meets the MTA.</p>
  </div>
